  ...
  public: {
    Tables: {
      ...
      pilihan_polling: {
        ...
        Relationships: [
          {
            foreignKeyName: "pilihan_polling_polling_id_fkey"
            columns: ["polling_id"]
            isOneToOne: false
      ...
      polling: {
        ...
        Relationships: [
          {
            foreignKeyName: "polling_author_id_fkey"
            columns: ["author_id"]
            isOneToOne: false
            referencedRelation: "anggota"
            referencedColumns: ["id"]
      ...
      vote: {
        ...
        Relationships: [
          {
            foreignKeyName: "vote_anggota_id_fkey"
            columns: ["anggota_id"]
            isOneToOne: false
            referencedRelation: "anggota"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "vote_pilihan_id_fkey"
            columns: ["pilihan_id"]
            isOneToOne: false
            referencedRelation: "pilihan_polling"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "vote_polling_id_fkey"
            columns: ["polling_id"]
            isOneToOne: false
            referencedRelation: "polling"
            referencedColumns: ["id"]
